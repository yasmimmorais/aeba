...
<body>
		...
		<div class="row">
			<div class="card m-3 p-0">
				...
				<!-- Carrossel de imagens do produto -->
			     <div id="carouselProduto" class="carousel slide col-md-5" data-ride="carousel">
				  <div class="carousel-inner">
				    <div class="carousel-item active">
				      <img class="d-block img-fluid"  src="assets/img/produto.jpg" alt="Primeiro Slide">
				    </div>
				    <div class="carousel-item">
				      <img class="d-block img-fluid" src="assets/img/produto.jpg" alt="Segundo Slide">
				    </div>
	...
	<section class="container">
		<div class="row">
			<div class="col-md-12 pt-4 mx-auto mt-3">
				<h2 class="title pt-3 pb-1">Veja outros produtos da categoria:</h2>
		...
		<div class="row">
			<!-- Produtos ofertados pela empresa -->
				<div class="border m-3 col-md-2 p-0">
				<!-- Imagem do produto -->
				  <img class="card-img-top img-fluid" src="assets/img/produto.jpg" alt="Imagem de capa do card">
				  <div class="card-body">
				  	<!-- Nome do produto -->
